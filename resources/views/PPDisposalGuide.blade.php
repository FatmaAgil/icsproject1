<x-PlasticDisposalLayout>
    <main id="main">
        @section('content')
            <div class="hero-section"style="background-image: url('{{ asset('assets/img/pp.png') }}'); background-size: cover; height: 100vh;">
            ...
            <section class="technology-section my-4">
                @foreach ($ppPlastics as $ppPlastic)
                    <h3 class="card-title">{{ $ppPlastic->title }}</h3>
                    <div class="technology-container">
                        <div class="PET">
                            <div class="card-body">
                                <h3>Introduction</h3>
                                <p class="card-text">{{ $ppPlastic->introduction }}</p>
                            </div>
                        </div>
                        <div class="PET">
                            <div class="card-body">
                                <div class="environmental-impact">
                                    ...
                                    <p>{{ $ppPlastic->environmental_impact }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="PET">
                        ...
                        <div class="PET">
                            <div class="card-body">
                                <div class="physical-properties">
                                    ...
                                    <ul>
                                        @if(is_array($ppPlastic->physical_properties))
                                            @if(isset($ppPlastic->physical_properties['density']))
                                                <li>Density: {{ $ppPlastic->physical_properties['density'] }} g/cm³</li>
                                            @else
                                                <li>Density: N/A</li>
                                            @endif
                                            @if(isset($ppPlastic->physical_properties['melting_point']))
                                                <li>Melting Point: {{ $ppPlastic->physical_properties['melting_point'] }} °C</li>
                                            @else
                                                <li>Melting Point: N/A</li>
                                            @endif
                                            @if(isset($ppPlastic->physical_properties['tensile_strength']))
                                                <li>Tensile Strength: {{ $ppPlastic->physical_properties['tensile_strength'] }} MPa</li>
                                            @else
                    ...
                    <div class="video-links">
                        ...
                        <div class="list-group">
                            @foreach(explode(',', $ppPlastic->video_links) as $link)
                    ...
                    <section class="quiz-section">
                        <h2>Quiz: How well do you know PP plastic recycling?</h2>
                        <form id="quizForm" action="{{ route('PPDisposalGuide.quiz') }}" method="post">
                            @csrf
                            @foreach($ppQuestions as $question)
            ...
            <script>
                ...
                function generatePlastics() {
                    for (let i = 0; i < 40; i++) {
                        ...
                        plastic.innerHTML = `<img src="{{ asset('assets/img/ppGame.png') }}" alt="Plastic">`;
