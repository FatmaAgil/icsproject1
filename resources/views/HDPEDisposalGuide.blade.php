<x-PlasticDisposalLayout>
    <main id="main">
        @section('content')
        <div class="hero-section"style="background-image: url('{{ asset('assets/img/HDPEImage.png') }}'); background-size: cover; height: 100vh;">
            <div class="hero-overlay">
                <div class="hero-content">
                    <h1>HDPE Plastic Disposal: Let's Make a Difference!</h1>
                    <p>Learn how to recycle HDPE plastics and contribute to a sustainable future</p>
        ...
        <section class="technology-section">
            ...
            <div class="technology-container">
                <div class="PET">
                    <div class="card-body">
                        <h3>Introduction</h3>
                        <p class="card-text">{{ $hdpePlastic->introduction }}</p>
                    </div>
                </div>
                ...
                <div class="PET">
                    <div class="card-body">
                        ...
                        <p>{{ $hdpePlastic->environmental_impact }}</p>
                    </div>
                </div>
                </div>
                ...
                <div class="PET">
                    <div class="card-body">
                        ...
                        <p>{{ $hdpePlastic->recycling_info }}</p>
                    </div>
                </div>
                </div>
                ...
                <div class="video-links">
                    ...
                    <div class="list-group">
                        @foreach(explode(',', $hdpePlastic->video_links) as $link)
        ...
        <section class="quiz-section">
            <h2>Quiz: How well do you know HDPE plastic recycling?</h2>
            <form id="quizForm" action="{{ route('HDPEDisposalGuide.quiz') }}" method="post">
                @csrf
                @foreach($hdpeQuizzes as $question)
            ...
            @if(session('quiz_score'))
                <p>You scored {{ session('quiz_score') }} out of {{ count($hdpeQuizzes) }}!</p>
            @endif
        </section>
